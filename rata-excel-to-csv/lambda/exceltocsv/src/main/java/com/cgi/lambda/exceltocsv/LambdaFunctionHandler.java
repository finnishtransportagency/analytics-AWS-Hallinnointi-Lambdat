...
public class LambdaFunctionHandler implements RequestHandler<S3Event, String> {
	...
	public String handleRequest(S3Event event, Context context) {
		...
		*/
		...
		String[] filesToProcess = listOfFiles.split("; ");
	...
	public FileSpec makeDataFileName(String name) {
		...
		retval.path += retval.prefix + name + "/";
		...
		retval.fileName = "table." + retval.prefix + name + "." + retval.timestamp + ".fullscanned.true.delim.semicolon.skiph.1.csv";
		return retval; 
